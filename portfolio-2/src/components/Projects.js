    ...
    <div>
                ...
                <Card style={{ width: "25rem", border:'none'}}>
                  ...
                  <Card.Body>
                    ...
                    <Button variant="warning" style={{background:'#005BAB', border: 'none', color: 'white'}} href='https://lomtuna.github.io/whatcha-drinking/' target="_blank">Live Demo</Button>
                    <Button variant="secondary" href="https://github.com/LomTuna/whatcha-drinking" target="_blank">Code</Button>
                    </div>
                  </Card.Body>
                </Card>
                <Card style={{ width: "25rem", border:'none'}}>
                  ...
                  <Card.Body>
                    <div className='projTitle'>
                    <Card.Title style={{fontFamily: 'Lexend Deca', fontSize: '30px', color: '#000'}}>Pathfinder</Card.Title>
                    </div>
                    <div className="projDetails">
                    <Card.Text style={{fontFamily: 'League Spartan', fontSize: '20px', color: '#000'}}>
                    ...
                    <div className="projButton">
                    <Button variant="warning" style={{background:'#005BAB', border: 'none', color: 'white'}} href="" target="_blank">Live Demo</Button>
                    <Button variant="secondary" href="https://github.com/CollinA7/path-finder" target="_blank">Code</Button>
                    </div>
                  </Card.Body>
                </Card>
          </div>
